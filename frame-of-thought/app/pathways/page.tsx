    ...
    <div className="min-h-screen bg-[#1a1612] text-stone-200">
      <div className="mx-auto max-w-5xl px-6 py-16">
        <div className="mb-12 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link
            href="/pathways/new"
            className="inline-flex w-fit items-center rounded border border-amber-700/60 bg-amber-900/20 px-5 py-2.5 text-xs font-semibold uppercase tracking-wider text-amber-400 transition-colors hover:bg-amber-900/40 hover:text-amber-300"
          >
            Create Pathway
          </Link>
        </div>
