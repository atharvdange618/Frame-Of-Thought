  ...
  return (
    <div className="min-h-screen animate-pulse transition-colors duration-200">
      <div className="mx-auto max-w-5xl px-6 py-16">
        <div className="mb-8 h-4 w-16 rounded bg-stone-200 dark:bg-stone-700" />
        ...
        <div className="flex flex-col gap-8 sm:flex-row sm:items-start">
          ...
          <div className="flex flex-col gap-4 flex-1">
            ...
            <div className="h-4 w-1/3 rounded bg-stone-200/60 dark:bg-stone-800" />
            ...
            <div className="mt-2 h-8 w-36 rounded bg-stone-200 dark:bg-stone-700" />
          </div>
        </div>
