    ...
    <div className="min-h-screen animate-pulse transition-colors duration-200">
      <div className="mx-auto max-w-5xl px-6 py-16">
        <div className="mb-12 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <div className="h-9 w-32 rounded bg-stone-200 dark:bg-stone-800" />
            <div className="mt-3 h-4 w-72 rounded bg-stone-200/60 dark:bg-stone-800/60" />
          </div>
          <div className="h-9 w-36 rounded bg-stone-200 dark:bg-stone-800" />
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          {Array.from({ length: 4 }).map((_, i) => (
            ...
            >
              <div className="mb-2 h-5 w-3/4 rounded bg-stone-200 dark:bg-stone-800" />
              ...
              <div className="h-3 w-1/3 rounded bg-stone-200/30 dark:bg-stone-800/30" />
            </div>
          ))}
        </div>
      </div>
