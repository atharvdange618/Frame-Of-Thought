...
export function PathwayBuilder({
  ...
  if (items.length === 0) {
    return (
      <p className="rounded-sm border border-dashed border-stone-300 dark:border-stone-800 px-4 py-8 text-center text-sm italic text-stone-500 dark:text-stone-400">
